...
{
if(!strcmp(str,"if")||!strcmp(str,"while")||!strcmp(str,"for")||!strcmp(str,"else")||!strcmp(str,"return")||!strcmp(str,"break")||!strcmp(str,"continue")||!strcmp(str,"do")||!strcmp(str,"int")||!strcmp(str,"static")||!strcmp(str,"float"))
   return true;
return false;
}
